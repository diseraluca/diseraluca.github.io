...
![An example of a smoothing algorithm. Left - Non Smoothed Mesh \ Right - Smoothed Mesh]({{ "/assets/images/DeltaMushIntroduction_CaseStudy_smoothExample.png" | absolute_url }})
...
![Tangent Space]({{ "/assets/images/DeltaMushIntroduction_CaseStudy_tangentSpaceExample.png" | absolute_url }})
